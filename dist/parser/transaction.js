...
function parseTransaction(rawHex) {
    ...
    const reader = new buffer_reader_1.BufferReader(buf);
 ...
 */
function buildTxidPreimage(version, inputs, outputs, locktime) {
    const parts = [];
    // Version
 ...
 */
function computeTxid(preimage) {
    const hash = (0, hash_1.doubleSha256)(preimage);
