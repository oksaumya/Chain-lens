"use strict";
/**
 * opcodes.ts — Bitcoin Script opcode definitions
 *
 * Complete opcode table following Bitcoin Core's script/script.h
 */
...
function getOpcodeName(byte) {
    ...
    return exports.OPCODES[byte] ?? `OP_UNKNOWN_0x${byte.toString(16).padStart(2, '0')}`;
}
