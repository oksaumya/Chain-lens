...
/* ------------------------------------------------------------------ */
/*  Raw parsed structures (from binary)                                */
/* ------------------------------------------------------------------ */

export interface RawInput {
  txid: string;       // 64-char hex, display order (reversed)
  vout: number;
  scriptSig: Buffer;
  sequence: number;
}
...
export interface ParsedTransaction {
  ...
  inputs: RawInput[];
  outputs: RawOutput[];
  witness: Buffer[][];  // witness[inputIndex][stackItem]
  locktime: number;
  segwit: boolean;
...
/* ------------------------------------------------------------------ */
/*  Prevout (from fixture or undo data)                               */
/* ------------------------------------------------------------------ */
